...
@Composable
fun ChangesLoadingState(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text("Cargando cambios...", style = MaterialTheme.typography.bodyMedium)
            }
        }
    }
}
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text(
                    text = "No hay cambios para este proyecto",
                    style = MaterialTheme.typography.titleSmall,
                    fontWeight = FontWeight.SemiBold,
                )
                Text(
                    text = "Puedes crear un cambio nuevo para iniciar el seguimiento.",
